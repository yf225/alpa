...
def array_init_like(array, init_func, **kwargs):
    ...
    if isinstance(array, DistributedArray):
        ...
        ret = DistributedArray(device_mesh, array.aval, array.sharding_spec, buf_refs, indices)
    ...
    if ret is not None:
        ...
        raise NotImplementedError(f"init_like does not support array of type {type(array)}")
